...
Для макбуков с процессом М1 рекомедуется использовать python 3.10 для корректной работы зависимости scrapy.
...
- Файл "status*summary*<дата сохранения>.csv" содержит информацию о полученных статусах PEP, о количестве PEP с каждым статусом и об общем количестве PEP.
